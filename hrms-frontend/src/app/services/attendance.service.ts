...
export class AttendanceService {
    ...
    // Manual checkout - HR/Admin only
    manualCheckOut(employeeId: string, date: string, time: string): Observable<any> {
        const payload = {
            employeeId,
            date,
            time
        };
        return this.http.post(`${this.apiUrl}/manual-checkout`, payload);
    }
}
